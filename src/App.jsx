    ...
    return (
        <div className="Forecast">
          ...
          <h1>Good {greetingTime} Ready to see the weather that lies ahead?</h1>
            ...
            <p>Take a look at your local area <a href={`https://www.google.co.uk/maps/@${userCoordinates},12z`} target="_blank"> here</a></p>

            <p>Need directions? Just tell me <a href={`https://www.google.co.uk/maps/dir/${userCoordinates}/blackpool`} target="_blank"> where to??</a></p>
